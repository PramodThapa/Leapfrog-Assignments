class Player{
    ...
    drawPlayer(){
        ctx.drawImage(characterImg, this.frameX * this.width, this.frameY * this.height, this.width, this.height, this.xPosition, this.yPosition , TILES_WIDTH, TILES_HEIGHT);
    }
        ...
        window.addEventListener('keydown', (e)=>{
            switch(e.key){
               case 'ArrowDown':                  
                ...
                case 'ArrowLeft':
                    if(this.xPosition > 0){
                        if(COLLISION_ARRAY[this.mapY][this.mapX - 1] != 1 && COLLISION_ARRAY[this.mapY][this.mapX - 1] != 2){
    ...
    jumpPlayer(){
        ...
        addEventListener('keydown',(e)=>{
            ...
            if(keyPressed[' '] ){
                if(COLLISION_ARRAY[this.mapY - 1][this.mapX] != 1 && COLLISION_ARRAY[this.mapY - 1][this.mapX] != 2 && FUEL != 0){
                    this.jumping = true;
                    this.yPosition -= 5;
                    FUEL -= 2;
                    this.mapY = Math.floor(this.yPosition / TILES_HEIGHT)
            ...
            if(keyPressed[' '] && keyPressed ['ArrowRight']){
                if(COLLISION_ARRAY[this.mapY - 1][this.mapX] != 1 && COLLISION_ARRAY[this.mapY - 1][this.mapX] != 2 && COLLISION_ARRAY[this.mapY][this.mapX + 1] != 1 && COLLISION_ARRAY[this.mapY][this.mapX + 1] != 2){
                    this.jumping =  true;
                    this.yPosition -= 2;
                    this.xPosition += 2;
