...
//FUNCTION TO GENERATE RANDOMM INTEGER
...
function detectCollision(xPosition, yPosition, height, width){
    ...
    if(playerRight > xPosition && playerLeft < xPosition + width && playerBottom > yPosition && playerTop < yPosition + height){
        return true;
    }else{
        return false;
    }
...
function detectMouseCollision(mouseXPosition, mouseYPosition, elementWidth, elementHeight, elementXPosition, elementYPosition){
    if(mouseXPosition > elementXPosition && mouseXPosition < elementXPosition + elementWidth && mouseYPosition > elementYPosition && mouseYPosition < elementYPosition + elementHeight){
        return true;
    }else{
        return false;
    }
