...
const COIN_POSITION_STAGE_1 = [
    {X:20,Y:22}
    // , {X:6,Y:20}, {X:30,Y:20}, {X:28,Y:16}, {X:20,Y:16}, {X:23,Y:18}, {X:17,Y:18},
    // {X:1,Y:16}, {X:10,Y:16},  {X:15,Y:13}, {X:26,Y:13},
    // {X:10,Y:11}, {X:5,Y:9}, {X:10,Y:5}, {X:1,Y:6}, {X:1,Y:2}, {X:6,Y:1},
    // {X:19,Y:1}, {X:29,Y:1}, {X:13,Y:3}, {X:29,Y:6}, {X:20,Y:6}, {X:23,Y:9},
    // {X:13,Y:3}, {X:13,Y:9}, {X:17,Y:9}, {X:13,Y:7},{X:17,Y:7}, {X:17,Y:16}, {X:13,Y:16},
...
const COIN_POSITION_STAGE_2 = [
    {X:20,Y:21}
    // , {X:3,Y:20}, {X:27,Y:21}, {X:28,Y:16}, {X:23,Y:15}, {X:23,Y:18}, {X:17,Y:18},
...
const COIN_POSITION_STAGE_3 = [
    {X:20,Y:20}
    // , {X:4,Y:20}, {X:30,Y:19}, {X:27,Y:16}, {X:23,Y:22}, {X:23,Y:18}, {X:17,Y:18},
